...
public class CrudeSoulInfuserRecipeCategory implements RecipeCategory {
    @NotNull
    ...
    @NotNull
    private final AMIDrawable background = DrawableHelper.createDrawable("/assets/crimsonforest/gui/crude_soul_infuser.png", 22, 16, 116, 54);

    public CrudeSoulInfuserRecipeCategory() {
        StaticDrawable flameDrawable = DrawableHelper.createDrawable("/assets/crimsonforest/gui/crude_soul_infuser.png", 176, 0, 14, 14);
        this.flame = DrawableHelper.createAnimatedDrawable(flameDrawable, 300, AnimatedDrawable.StartDirection.TOP, true);
        StaticDrawable arrowDrawable = DrawableHelper.createDrawable("/assets/crimsonforest/gui/crude_soul_infuser.png", 176, 14, 24, 17);
