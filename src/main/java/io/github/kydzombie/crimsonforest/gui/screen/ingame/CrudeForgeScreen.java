...
public class CrudeForgeScreen extends HandledScreen {
    CrudeForgeBlockEntity blockEntity;

    public CrudeForgeScreen(PlayerInventory playerInventory, CrudeForgeBlockEntity blockEntity) {
        super(new CrudeForgeScreenHandler(playerInventory, blockEntity));
