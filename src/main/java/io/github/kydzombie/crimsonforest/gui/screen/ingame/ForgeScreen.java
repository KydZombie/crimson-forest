...
public class ForgeScreen extends HandledScreen {
    CrudeForgeBlockEntity blockEntity;

    public ForgeScreen(PlayerInventory playerInventory, CrudeForgeBlockEntity blockEntity) {
        super(new ForgeScreenHandler(playerInventory, blockEntity));
    ...
    protected void drawBackground(float tickDelta) {
        int var2 = minecraft.textureManager.getTextureId("/assets/crimsonforest/gui/forge.png");
